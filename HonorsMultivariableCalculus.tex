...
In 32BH, we will shift our focus from proving theorems, to understanding complex mathematical definitions and concepts
...
\input{./chapters/2-RealAnalysis/RealAnalysis.tex}

\chapter{The Multivariable Derivative}


\input{./chapters/3-Derivatives/derivatives.tex}

\chapter{Integration on $\R^n$}

\input{chapters/4-IntegrationRn/integration.tex}
