...
\begin{theorem}[The single-variable second derivative test]
...
Recall from \fixthis{Reference} that the derivative of a linear transformation $T$ is $T$ itself. Thus, we can 
...
\begin{theorem}[Clairaut's theorem]
    ...
    Clairaut's theorem is more commonly stated as the following corollary:
    \begin{corollary}
