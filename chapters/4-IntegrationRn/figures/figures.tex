...
\usepgfplotslibrary{colormaps,fillbetween,polar}
...
$\frac{3\pi}{2}$, $\frac{5\pi}{3}$,$\frac{11\pi}{6}$,}, grid=both,
            minor grid style={dashed,black!25},
            major grid style={dashed,black!50},
...
\begin{tikzpicture}[scale=2]
   \begin{polaraxis}[%
            ...
            my style polar]
   \begin{scope}[]
        \addplot+[mark=none,draw=none,domain=20:60,name path=B] {2};
        \addplot+[mark=none,draw=none,domain=20:60,name path=A] {1};  
        \addplot+[mark=none,domain=20:60,samples=100,smooth,ultra thick,UCLAblue] {2};
        \addplot+ [mark=none,domain=20:60,samples=100,smooth,ultra thick,UCLAblue] {1};  
        \addplot[ultra thick,UCLAblue] plot coordinates {(60,1) (60,2)};
        \addplot[ultra thick,UCLAblue] plot coordinates {(20,1) (20,2)};         
        \tikzfillbetween[of=A and B]{UCLAgold}; %fill
  \end{scope}
    \end{polaraxis}
  \end{tikzpicture}
...
\begin{tikzpicture}
   \begin{polaraxis}[%
            ...
            my style polar]
   \begin{scope}[]
        \addplot+[mark=none,draw=none,domain=20:120,name path=B] {2*rad(x)};
        \addplot+[mark=none,draw=none,domain=20:120,name path=A] {rad(x)};  
        \addplot+[mark=none,domain=20:120,samples=100,smooth,ultra thick,UCLAblue] {2*rad(x)} node[midway,above right]{$r = 2\theta$};
        \addplot+ [mark=none,domain=20:120,samples=100,smooth,ultra thick,UCLAblue] {rad(x)} node[midway, below left]{$r = \theta$};  
        %\addplot[ultra thick,UCLAblue] plot coordinates {(60,1) (60,2)};
        %\addplot[ultra thick,UCLAblue] plot coordinates {(20,1) (20,2)};         
        \tikzfillbetween[of=A and B,samples=100]{UCLAgold}; %fill
  \end{scope}
    \end{polaraxis}
  \end{tikzpicture}
...
\begin{tikzpicture}
   \begin{polaraxis}[%
            my style polar]
   \begin{scope}[]
        \addplot+[mark=none,draw=none,domain=0:360,name path=B] {2-2*sin(x)};
        \addplot+[mark=none,draw=none,domain=0:360,name path=A] {0};  
        %\addplot[ultra thick,UCLAblue] plot coordinates {(60,1) (60,2)};
        %\addplot[ultra thick,UCLAblue] plot coordinates {(20,1) (20,2)};         
        \tikzfillbetween[of=A and B]{UCLAgold,opacity=0.7}; %fill        
        \addplot+[mark=none,domain=0:360,samples=200,smooth,ultra thick,UCLAblue] {2-2*sin(x)} node[yshift=1cm]{$r = 2-2\sin(\theta)$};
        \addplot+[mark=none,domain=0:360,samples=200,smooth,ultra thick,UCLAblue] {0};  
  \end{scope}
    \end{polaraxis}
  \end{tikzpicture}
...
\begin{tikzpicture}[scale=3, tdplot_main_coords]
    ...
    \draw[thick,-Latex] (0,0,0) -- (1.25,0,0) node[anchor=north east]{$x$};
    \draw[thick,-Latex] (0,0,0) -- (0,1.25,0) node[anchor=north west]{$y$};
    \draw[thick,-Latex] (0,0,0) -- (0,0,1.25) node[anchor=south]{$z$};
    \tdplotsetcoord{P}{1}{30}{60}
    \draw plot [mark=*, mark size=0.2] (P) node [right] {\scriptsize$(r,\theta,z)$};
    \draw[dashed] (O) -- (P);
    \draw[thick, color=UCLAblue] (O) -- (Pxy) node [below right] {$r$};
    \draw[dashed, color=black] (P) -- (Pxy);
    \tdplotdrawarc[color=mered]{(O)}{0.2}{0}{60}{anchor=north}{$\theta$}
    \draw[dashed, color=black] (P) -- (Pz) node [left] {$z$};
\end{tikzpicture}
...
\begin{tikzpicture}[scale=3, tdplot_main_coords]
    ...
    \draw[thick,-Latex] (0,0,0) -- (0,0,1.25) node[anchor=south]{$z$};
    \tdplotsetcoord{P}{1}{30}{60}
    \draw plot [mark=*, mark size=0.2] (P) node [right] {\scriptsize$(\rho,\theta,\phi)$};
    \draw[thick, color=UCLAblue] (O) -- (P) node [midway, below right] {$\rho$};
    \draw[dashed, color=black] (O) -- (Pxy);
    \draw[dashed, color=black] (P) -- (Pxy);
    \tdplotdrawarc[color=mered]{(O)}{0.2}{0}{60}{anchor=north}{$\theta$}
    \tdplotsetthetaplanecoords{60}
    \tdplotdrawarc[color=UTorange,tdplot_rotated_coords]{(0,0,0)}{0.4}{0}%
        {30}{anchor=south}{$\phi$}
\end{tikzpicture}
